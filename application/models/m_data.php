...
class M_data extends CI_Model{
    ...
    var $table = 'tb_bookmark';
    var $column_order = array('title','url','description',null); //set column field database for datatable orderable
    var $column_search = array('title','url'); //set column field database for datatable searchable just firstname , lastname , address are searchable
